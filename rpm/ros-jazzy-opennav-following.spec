...
Name:           ros-jazzy-opennav-following
Version:        1.0.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS opennav_following package
...
BuildRequires:  ros-jazzy-opennav-docking
BuildRequires:  ros-jazzy-opennav-docking-core
...
%description
Jazzy-compatible backport of Nav2's dynamic object following action server
(opennav_following, originally developed for the navigation2 &quot;main&quot;
branch by Open Navigation LLC and Alberto J. Tudela Roldán). Self-contained:
ships its own FollowObject action so it installs standalone on ROS 2 Jazzy.
...
%changelog
* Mon Jul 20 2026 Marcos Daniel Santana Grochoska <marcos.daniel1990@hotmail.com> - 1.0.0-1
